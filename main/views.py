...
def profile_update(request):
    ...
    if request.method == 'POST':
        ...
        if profile.is_valid():
            ...
            messages.success(request, f'dear {new} your profile update is sucessful')
...
def password_update(request):
    ...
    if request.method == 'POST':
        ...
        if passupdate:
            ...
            messages.error(request, f'the following errors ocurred: {passupdate.errors}')
...
def payment(request):
    if request.method == 'POST':
        ...
        api_key = 'sk_test_9bab2b4c59615691e8ebcf219adada216653e4c2' #secret key from paystack
        curl = 'https://api.paystack.co/transaction/initialize' #paystack call url
        cburl = 'http://127.0.0.1:8000/callback' #thank you page
        ...
        try:
            ...
            messages.error(request, 'netwwork busy, try again later')
        else:
